...
\begin{abstract}
This paper combines Soft Systems Methodology and UML modelling to design a
high-level view of a search application that receives web content
from a variety of BBC content production systems and makes every item
then searchable by a BBC website visitor using the search feature.
\end{abstract}
