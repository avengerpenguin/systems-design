...
needs of the television-watching public. It is not always the case
that the holistic system will behave predictably from the behaviours
of its parts.
...
class Programme extends CreativeWork
